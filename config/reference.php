 ...
 * }
 * @psalm-type Daemon8Config = array{
 *     enabled?: bool|Param, // Default: true
 *     app?: scalar|Param|null, // Default: null
 *     debug?: bool|Param, // Default: false
 *     transport?: array{
 *         url?: scalar|Param|null, // Default: "http://127.0.0.1:9077/ingest"
 *         mode?: null|"sync"|Param, // Default: null
 *         timeout_ms?: int|Param, // Default: 50
 *         batch_size?: int|Param, // Default: 100
 *     },
 *     sensitive?: array{
 *         sanitizer?: scalar|Param|null, // Default: "Daemon8\\Sanitization\\Sanitizer"
 *         mask?: scalar|Param|null, // Default: "[masked]"
 *         fields?: list<scalar|Param|null>,
 *         headers?: list<scalar|Param|null>,
 *         patterns?: list<scalar|Param|null>,
 *     },
 *     exception?: array{
 *         include_arguments?: bool|Param, // Default: false
 *         limit?: int|Param, // Default: 50
 *     },
 *     monolog?: array{
 *         enabled?: bool|Param, // Default: false
 *     },
 ...
 *         enabled?: bool|Param, // Default: false
 *     },
 *     watchers?: array<string, array{ // Default: {"Daemon8\\Symfony\\EventSubscriber\\RequestSubscriber":{"enabled":true},"Daemon8\\Symfony\\EventSubscriber\\ExceptionSubscriber":{"enabled":true},"Daemon8\\Symfony\\EventSubscriber\\CommandSubscriber":{"enabled":true},"Daemon8\\Symfony\\Messenger\\MessengerSubscriber":{"enabled":true},"Daemon8\\Symfony\\Security\\SecuritySubscriber":{"enabled":true},"Daemon8\\Symfony\\HttpClient\\Daemon8HttpClient":{"enabled":true},"Daemon8\\Symfony\\Monolog\\Daemon8Handler":{"enabled":true},"Daemon8\\Symfony\\Doctrine\\Daemon8QueryMiddleware":{"enabled":true},"Daemon8\\Symfony\\Doctrine\\MigrationListener":{"enabled":true},"Daemon8\\Symfony\\Mailer\\MailerSubscriber":{"enabled":false},"Daemon8\\Symfony\\Doctrine\\ModelListener":{"enabled":false},"Daemon8\\Symfony\\EventSubscriber\\CacheSubscriber":{"enabled":false}}
 *         enabled?: bool|Param, // Default: true
 *         size_limit?: int|Param, // Default: 65536
 *         slow?: int|Param, // Default: 100
 *         all?: bool|Param, // Default: false
 *         level?: scalar|Param|null, // Default: "warning"
 *         observe_retries?: "per_logical"|"per_attempt"|Param, // Default: "per_logical"
 *         events?: list<scalar|Param|null>,
 *     }>,
 *     respondents?: list<scalar|Param|null>,
 * }
